...
# ================= PAGE CONFIG =================
st.set_page_config(page_title="SmartCare Health", layout="wide")
...
24:'Hyperthyroidism',25:'Hypoglycemia',31:'Osteoarthritis',
5:'Arthritis',0:'(Vertigo) Paroxysmal Positional Vertigo',
